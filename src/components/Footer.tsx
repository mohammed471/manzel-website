...
export default async function Footer() {
  ...
  return (
    <footer className="bg-primary-dark text-white relative overflow-hidden">
      {/* Decorative blobs */}
      <div className="absolute top-0 start-0 w-72 h-72 bg-primary/30 rounded-full -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 end-0 w-96 h-96 bg-primary/20 rounded-full translate-x-1/3 translate-y-1/3" />
      <div className="absolute top-1/2 end-1/4 w-48 h-48 bg-accent/5 rounded-full" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Company Info */}
          <div>
            <Logo variant="light" width={100} height={40} />
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li>
                ...
                >
                  ...
                  <span dir="ltr">0773 768 5000</span>
                </a>
              </li>
              {/* Phone 2 */}
              <li>
                <a
                  href="tel:+9647737686000"
                  className="flex items-start gap-3 hover:text-accent transition-colors"
                >
                  <svg
                    className="w-5 h-5 mt-0.5 text-accent shrink-0"
                  ...
                  <span dir="ltr">0773 768 6000</span>
                </a>
              </li>
              ...
              <li>
                ...
                >
                  ...
                  <span>contact.manzel@gmail.com</span>
                </a>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <span>{tContact("working_hours_value")}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/Manzel.Design.House/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-accent/20 hover:text-accent transition-colors"
              aria-label="Facebook"
            >
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/manzel.design.house/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-accent/20 hover:text-accent transition-colors"
