  ...
  if (canNativeShare) {
    return (
      <button
        ...
        className="flex items-center justify-center gap-2 w-full mt-4 bg-primary/10 hover:bg-primary/20 text-primary font-medium px-5 py-3 rounded-xl transition-colors text-sm"
      >
  ...
  return (
    <div className="mt-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={handleCopy}
          className="relative w-10 h-10 rounded-full bg-surface hover:bg-secondary-dark/30 flex items-center justify-center transition-colors"
          title={t("copy_link")}
        >
          {copied ? (
          ...
          {copied && (
            <span className="absolute -top-8 start-1/2 -translate-x-1/2 bg-text-primary text-white text-xs px-2 py-1 rounded whitespace-nowrap">
              {t("copied")}
            </span>
          )}
        </button>
